...
public class AiTwoActions : MonoBehaviour
{
    ...
    private void resetAll()
    {
        ...
        findFirstWayPoints("_WP");
    }

    public void findFirstWayPoints(string name)
    {
        Transform[] potentialWayPoints = GameObject.Find(gameObject.name + name).GetComponentsInChildren<Transform>();
